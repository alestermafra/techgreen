...
<p><b>1. DOS EQUIPAMENTOS E SEUS ACESSÓRIOS</b><br />
  ...
  1.2 Eventuais alterações no(s) equipamento(s) e acessório(s) deverão ser comunicados ao ATENDIMENTO para que seja feita a alteração no Sistema de guardaria. <br />
  1.3 Caso o PROPRIETÁRIO não comunique as modificações a PÊRA NÁUTICA não se responsabilizará pelo equipamento ou acessório que não esteja no Sistema de guardaria. <br />
  ...
  1.7 O VELEJADOR poderá transferir seu(s) equipamento(s) e acessório(s) para as sedes da BL3 ILHABELA em Ilhabela/SP – base Armação e base Engenho d’Água, mediante consulta prévia da disponibilidade de guardaria junto ao local pretendido,</p>
<p>2. DO PRAZO<br />
  2.1 O prazo para a guardaria do(s) equipamento(s) e acessório(s) do VELEJADOR será conforme o plano abaixo escolhido, com início a partir da data de assinatura deste contrato.<br />
</p>
<p><b>3. DO PAGAMENTO</b><br />
  ...
  3.2 O VELEJADOR que tiver um segundo equipamento terá desconto de 20% no valor de sua guardaria.<br />
