...
<nav class="navbar navbar-light">
	<span class="navbar-brand">Colaboradores</span>
    
	<div>
		<a href="<?php echo $this->url('/colaboradores/inserir_pf') ?>" class="btn btn-sm btn-success" role="button" title="Novo registro">Adicionar</a>
	</div>
</nav>
...
<div class="container-fluid">
	<div class="card">
		<div class="card-body py-2">
			<form action="<?php echo $this->url('/colaboradores/colaboradores_pf') ?>" method="GET">
				<div class="form-row">
...
<?php else: ?>
	<div class="table-responsive">
		<table class="table table-sm table-hover">
			...
			<tr>
				<td nowrap style="cursor: pointer" onclick="window.location = '<?php echo $this->url('/colaboradores/overview_pf/' . $d['cps']) ?>'"><?php echo $d['cps'] ?></td>
				<td nowrap style="cursor: pointer" onclick="window.location = '<?php echo $this->url('/colaboradores/overview_pf/' . $d['cps']) ?>'"><?php echo $d['nps'] ?></td>
			</tr>
			<?php endforeach; ?>
		   </tbody>
		</table>
	...
	<nav>
		<ul class="pagination pagination-sm justify-content-center">
			<li class="page-item <?php echo $page === 1? 'disabled':'' ?>">
				<a class="page-link" href="<?php echo $this->url('/colaboradores' . $url_get . '&page=1') ?>">Primeira</a>
			</li>
			<li class="page-item <?php echo $page <= 1? 'disabled':'' ?>">
				<a class="page-link" href="<?php echo $this->url('/colaboradores' . $url_get . '&page=' . ($page - 1)) ?>">Anterior</a>
			</li>
			<li class="page-item active"><a class="page-link" href="javascript:void(0)"><?php echo $page ?></a></li>
			<li class="page-item <?php echo ($pages === 0 || $page === $pages)? 'disabled':'' ?>"><a class="page-link" href="<?php echo $this->url('/colaboradores' . $url_get . '&page=' . ($page + 1)) ?>">Próxima</a></li>
			<li class="page-item <?php echo ($pages === 0 || $page === $pages)? 'disabled':'' ?>"><a class="page-link" href="<?php echo $this->url('/colaboradores' . $url_get . '&page=' . $pages) ?>">Última</a></li>
		</ul>
	</nav>
