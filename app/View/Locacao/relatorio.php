<?php
	...
	//excel
	if($excel == 1){
		$arquivo_nome = "Relatório_Locação_Equipamentos_".date("d/m/Y");
...
<nav class="navbar navbar-light">
	<span class="navbar-brand">Relatório de Locações de Equipamentos</span>
</nav>

<div class="container-fluid">
	<div class="card">
		<div class="card-body py-2">
			<form action="<?php echo $this->url('/locacao/relatorio') ?>" method="GET" id="form">
				<div class="form-row">
		...
		<table class="table table-sm table-hover">
			<thead class="thead-light">
				<tr>
                    ...
                    <th scope="col" class="small">Tipo/Tabela</th>
