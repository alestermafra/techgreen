<form action="<?php echo $this->url('/servicos/editar_precos/') ?>" method="POST">

<nav class="navbar navbar-light">
	<span class="navbar-brand">Editar Preço de Serviços</span>
	<div>
		<a class="btn btn-sm btn-light" role="button" style="width: 100px;" href="<?php echo $this->url('/servicos/precos/') ?>">Cancelar</a>
		...
		<div class="card">
			...
			<div class="card-body">
				<div class="form-group">
					<label class="small text-muted">Serviço / Produto</label> 
