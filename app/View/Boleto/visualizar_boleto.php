...
<tr>
	...
	<DIV ALIGN="CENTER">Instruçõesde Impressão</DIV>
	</td>
</tr>
<tr>
    <td valign=top class=cp>
...
<TBODY>
	<TR>
    	<TD class=ct width=666>
        	<img height=1 src=<?=$this->url('/img/6.png')?> width=665 border=0>
        </TD>
    </TR>
    <TR>
    	<TD class=ct width=666>
...
<table width=666 cellspacing=5 cellpadding=0 border=0 align=Default>
  <tr>
    <td width=41><IMG src="<?=$this->url('/img/logo.png')?>" width="65"></td>
...
<tr>
	<td class=cp width=150>
  		<span class="campo"><IMG src=<?=$this->url('/img/logoitau.gif')?> width="110" height="40" border=0></span>
    </td>
<td width=3 valign=bottom>
    	<img height=22 src=<?=$this->url('/img/3.png')?> width=2 border=0>
    </td>
...
<tr>
	<td colspan=5>
    	<img height=2 src=<?=$this->url('/img/2.png')?> width=666 border=0>
    </td>
</tr>
</tbody>
</table>
...
<tr>
	<td class=ct valign=top width=7 height=13>
    	<img height=13 src=<?=$this->url('/img/1.png')?> width=1 border=0>
    </td>
...
<tr>
	<td class=cp valign=top width=7 height=12>
    	<img height=12 src=<?=$this->url('/img/1.png')?> width=1 border=0>
    </td>
...
<tr>
	<td valign=top width=7 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0>
    </td>
<td valign=top width=298 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=298 border=0>
    </td>
<td valign=top width=7 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0>
    </td>
<td valign=top width=126 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=126 border=0>
    </td>
<td valign=top width=7 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0>
    </td>
<td valign=top width=34 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=34 border=0>
    </td>
<td valign=top width=7 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0>
    </td>
<td valign=top width=53 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=53 border=0>
    </td>
<td valign=top width=7 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0>
    </td>
<td valign=top width=120 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=120 border=0>
    </td>
</tr>
</tbody>
</table>
...
<tr>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=113 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=113 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=72 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=72 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=132 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=132 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=134 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=134 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
	<td valign=top width=180 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=180 border=0></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr>
    <td class=ct valign=top width=7 height=13><img height=13 src=<?=$this->url('/img/1.png')?> width=1 border=0></td>
...
<tr>
	<td class=cp valign=top width=7 height=12><img height=12 src=<?=$this->url('/img/1.png')?> width=1 border=0></td>
...
<tr>
    ...
    <td valign=top width=113 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=113 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=112 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=112 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=113 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=113 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=113 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=113 border=0></td>
...
<tr>
    ...
    </tr><tr><td class=cp valign=top width=7 height=12><img height=12 src=<?=$this->url('/img/1.png')?> width=1 border=0></td>
	<td class=cp valign=top width=659 height=12> <span class="campo"><?php echo $dadosboleto["sacado"]?></span></td>
</tr>
<tr>
	<td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
	<td valign=top width=659 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=659 border=0></td>
</tr>
</tbody>
</table>
...
<tr>
	<td class=cp width=150>
  	<span class="campo"><IMG src=<?=$this->url('/img/logoitau.gif')?> width="110" height="40"  border=0></span></td>
    <td width=3 valign=bottom><img height=22 src=<?=$this->url('/img/3.png')?> width=2 border=0></td>
    ...
    <td class=ld align=right width=453 valign=bottom><span class=ld>
    	<span class="campotitulo"><?php echo $dadosboleto["linha_digitavel"]?></span></span>
    </td>
</tr>
<tbody>
<tr>
	<td colspan=5><img height=2 src=<?=$this->url('/img/2.png')?> width=666 border=0></td>
</tr>
</tbody>
</table>
...
<tr>
	<td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
	<td valign=top width=472 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=472 border=0></td>
	<td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
	<td valign=top width=180 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=180 border=0></td>
</tr>
</tbody>
...
<tr>
    ...
    <td valign=top width=113 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=113 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=153 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=153 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=62 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=62 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=34 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=34 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=82 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=82 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=180 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=180 border=0></td>
</tr>
</tbody>
...
<tr>
    ...
    <td class=ct valign=top height=13 width=7> <img height=13 src=<?=$this->url('/img/1.png')?> width=1 border=0></td>
    ...
    <td class=ct valign=top width=7 height=13><img height=13 src=<?=$this->url('/img/1.png')?> width=1 border=0></td>
    <td class=ct valign=top width=180 height=13>(=)Valor documento</td></tr><tr> <td class=cp valign=top width=7 height=12><img height=12 src=<?=$this->url('/img/1.png')?> width=1 border=0></td>
...
<tr>
	<td valign=top width=7 height=1> <img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=75 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=31 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=31 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=83 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=83 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=53 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=53 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=123 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=123 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=72 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=72 border=0></td>
    <td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=7 border=0></td>
    <td valign=top width=180 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=180 border=0></td>
...
<tr>
	<td align=right width=10>
        ...
        <tr>
			<td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=1 border=0></td>
        </tr>
        </tbody>
        </table>
	</td>
...
<tr>
	<td align=right width=10>
        ...
        <tr><td valign=top width=7 height=1><img height=1 src=<?=$this->url('/img/2.png')?> width=1 border=0></td>
        </tr>
        </tbody>
        </table>
	</td>
...
<tr>
	<td valign=top width=666 height=1>
    	<img height=1 src=<?=$this->url('/img/2.png')?> width=666 border=0>
   	</td>
</tr>
</tbody>
</table>
...
<TR>
	...
	<td class=ct  width=250 ><div align=right>Autenticaçãomecânica - <b class=cp>Ficha de Compensação</b></div></TD>
</TR>
<TR>
...
//$img_url_p = $this->url('/img/p.png');
//$img_url_b = $this->url('/img/b.png');

function fbarcode($valor, $img_url_p, $img_url_b){
	$fino = 1 ;
	$largo = 3 ;
	$altura = 50 ;
	...
	//Guarda inicial
	/*?>*/
	$return_barra = $return_barra . "<img src=".$img_url_p." width=".$fino." height=". $altura." border=0>";
	$return_barra = $return_barra . "<img src=".$img_url_b." width=".$fino." height=". $altura." border=0>";
	$return_barra = $return_barra . "<img src=".$img_url_p." width=".$fino." height=". $altura." border=0>";
	$return_barra = $return_barra . "<img src=".$img_url_p." width=".$fino." height=". $altura." border=0>";
	$return_barra = $return_barra . "<img ";
	/*<?php*/
	$texto = $valor ;
	if((strlen($texto) % 2) <> 0){
		$texto = "0" . $texto;
	...
	/*?>*/
		$return_barra = $return_barra . " src=".$img_url_p." width=". $f1." height=". $altura." border=0>";
        $return_barra = $return_barra . "<img ";
	/*<?php*/
		if (substr($f,$i,1) == "0") {
		  $f2 = $fino ;
	...
	/*?>*/
		$return_barra = $return_barra . " src=".$img_url_b." width=". $f2." height=". $altura." border=0>";
		$return_barra = $return_barra . "<img "; 
	/*<?php*/
	  }
	}
	...
	// Draw guarda final
	/*?>*/
	$return_barra = $return_barra . " src=".$img_url_p." width=". $largo." height=". $altura." border=0>";
	$return_barra = $return_barra . "<img src=".$img_url_b." width=". $fino." height=". $altura." border=0>";
	$return_barra = $return_barra . "<img src=".$img_url_p." width=1 height=". $altura." border=0>";
	  /*<?php*/
...
?>
	<?=fbarcode($dadosboleto["codigo_barras"], $this->url('/img/p.png'), $this->url('/img/b.png'));?>
    </TD>
</tr>
</tbody>
</table>
...
<TR>
	<TD class=ct width=666><img height=1 src=<?=$this->url('/img/6.png')?> width=665 border=0></TD>
</tr>
</tbody>
</table>