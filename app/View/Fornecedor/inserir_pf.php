<form action="<?php echo $this->url('/fornecedor/inserir_pf') ?>" method="POST">
...
<div class="container-fluid">
	...
	<div class="form-group text-right">
		<a class="btn btn-sm btn-light" role="button" style="width: 100px;" href="<?php echo $this->url('/fornecedor/fornecedores_pf') ?>">Cancelar</a>
