<form action="<?php echo $this->url('/estoque/editar_linha') ?>" method="POST">

<nav class="navbar navbar-light">
	<span class="navbar-brand">Editar Linha</span>
	<div>
...
<?php endif ?>
    ...
    <input type="hidden" value="<?=$linha['clinha']?>" name="clinha">
	...
	<div class="container-fluid">
			...
			<div class="card-body">
				...
				<div class="form-group form-row">
					<div class="col-2">
						...
						<input name="slinha" type="text" class="form-control form-control-sm" placeholder="Sigla ou abreviação" autocomplete="off" maxlength="10" value="<?=$linha['slinha']?>"/>
					</div>
					<div class="col-10">
						<label class="small text-muted">Nome</label> 
						<input name="nlinha" type="text" class="form-control form-control-sm" placeholder="Nome da linha" autocomplete="off" required value="<?=$linha['nlinha']?>" />
					</div>
				</div>
		  </div>
		</div>
		...
		<div class="form-group">
			...
			<textarea name="descricao" class="form-control form-control-sm" rows="2" placeholder="(Opcional)"><?=$linha['descricao']?></textarea>
		</div>
