...
<nav class="navbar navbar-light">
	<span class="navbar-brand">Linhas de Produtos</span>
	<div>
		<a href="<?php echo $this->url('/estoque/inserir_linha') ?>" class="btn btn-sm btn-success" role="button" title="Novo registro">Adicionar Linha</a>
	</div>
</nav>
...
<div class="container-fluid">
	<div class="card">
		<div class="card-body py-2">
			<form action="<?php echo $this->url('/estoque/linhas/') ?>" method="GET">
				<div class="form-row">
		...
		<table class="table table-sm table-hover">
			...
			<tbody>
				<?php foreach($list as $d): ?>
					<tr style="cursor: pointer" onclick="window.location = '<?php echo $this->url('/estoque/editar_linha/' . $d['clinha']) ?>'">
						<td nowrap><?php echo $d['clinha'] ?></td>
						<td nowrap><?php echo $d['nscat'] ?></td>
						<td nowrap><?php echo $d['slinha'] ?></td>
	...
	<nav>
		<ul class="pagination pagination-sm justify-content-center">
			<li class="page-item <?php echo $page === 1? 'disabled':'' ?>">
				<a class="page-link" href="<?php echo $this->url('/estoque/linhas/' . $url_get . '&page=1') ?>">Primeira</a>
			</li>
			<li class="page-item <?php echo $page <= 1? 'disabled':'' ?>">
				<a class="page-link" href="<?php echo $this->url('/estoque/linhas/' . $url_get . '&page=' . ($page - 1)) ?>">Anterior</a>
			</li>
			<li class="page-item active"><a class="page-link" href="javascript:void(0)"><?php echo $page ?></a></li>
			<li class="page-item <?php echo ($pages === 0 || $page === $pages)? 'disabled':'' ?>"><a class="page-link" href="<?php echo $this->url('/estoque/linhas/' . $url_get . '&page=' . ($page + 1)) ?>">Próxima</a></li>
			<li class="page-item <?php echo ($pages === 0 || $page === $pages)? 'disabled':'' ?>"><a class="page-link" href="<?php echo $this->url('/estoque/linhas/' . $url_get . '&page=' . $pages) ?>">Última</a></li>
		</ul>
	</nav>
